...
import com.go.peaksu.api.ApiConfig;
import com.go.peaksu.api.AsyncSoal;
import com.go.peaksu.model.Pojo;
import com.go.peaksu.pref.PrefData;
import com.go.peaksu.quis.QuizActivity;
import com.go.peaksu.quis.QuizFragment;
import com.go.peaksu.utils.ActivityUtils;
...
public class MenuUtama extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportActionBar().setTitle("Go-Peaksu");
